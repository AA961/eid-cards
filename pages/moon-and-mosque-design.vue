...
let cardHeading = ref("Eid Al-Fitar");
                ...
                <div class="card-container" :style="{ backgroundColor: selectedColor.bg }">
                    <div class="left-side">
                        ...
                        <div class="edit-card-heading">
                            ...
                            <h1 :style="{ color: selectedColor.accent }" v-else
                        ...
                        <div class="to-and-from">
                            <div class="edit-to-name">
                                ...
                                <h3 v-else class="to" :style="{ color: selectedColor.secondary }"
                            ...
                            <div class="edit-qutation qutation">
                                ...
                                <p :style="{ color: selectedColor.secondary }" v-else
                            ...
                            <div class="edit-from">
                                ...
                                <h3 class="from" :style="{ color: selectedColor.secondary }" v-else
                    ...
                    <div class="img">
                        <img src="@/assets/imgs/moon-and-mosque.png" alt="">
                    </div>
...
.container {
    ...
    .card-wrapper {
        ...
        .card-container {
            background: rgb(4, 88, 108);
            background: linear-gradient(153deg, rgba(4, 88, 108, 1) 0%,
                    rgba(72, 153, 173, 1) 35%, rgba(212, 240, 238, 1) 100%);
            display: flex;
