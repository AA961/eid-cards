...
const sendOnWA = () => {
  ...
  html2canvas(cardPreview).then(async (canvas) => {
      ...
      if (navigator.canShare && navigator.canShare({ files: [file] })) {
        try {
          await navigator.share({
            ...
            files: [file], // Only image file is shared
          });
  ...
  <section>
    <div class="container">
          ...
          <div class="left-side">
            <div class="edit-to-name">
              <div class="edit" v-if="edit.isEditToName">
                ...
                <button @click="edit.isEditToName = !edit.isEditToName">
                  Save
                </button>
              </div>
              <h3
                ...
                @click="edit.isEditToName = !edit.isEditToName"
              >
                To {{ toName }}
              </h3>
            </div>
            ...
            <div class="edit-card-heading">
              <div class="edit" v-if="edit.isEditCardHeading">
                ...
                <button
                  @click="edit.isEditCardHeading = !edit.isEditCardHeading"
                >
                  Save
                </button>
              </div>
            ...
            <div class="edit-qutation qutation">
              <div class="edit" v-if="edit.isEditQoute">
                ...
                ></textarea>
                <button @click="edit.isEditQoute = !edit.isEditQoute">
                  Save
                </button>
              </div>
              <p
                :style="{ color: selectedColor.primary }"
                v-else
                @click="edit.isEditQoute = !edit.isEditQoute"
              >
                {{ selectedQuotation }}
              </p>
            </div>
            ...
            <div class="edit-from">
              <div class="edit" v-if="edit.isEditFromName">
                ...
                <button @click="edit.isEditFromName = !edit.isEditFromName">
                  Save
                </button>
              </div>
              <h3
                ...
                :style="{ color: selectedColor.primary }"
                v-else
                @click="edit.isEditFromName = !edit.isEditFromName"
              >
                From {{ fromName }}
              </h3>
            </div>
      ...
      <div class="create-your .mtb-3" v-if="visibleCardOnly">
        <button @click="createYourCard" class="button secondary .mtb-3">
          Create Your Card
        </button>
      </div>
      ...
      <div class="control-area" v-show="!visibleCardOnly">
        <div class="save-and-share">
          <button @click="saveCardAsImage" class="save-button button secondary">
            Save as Image
          </button>
          <button class="share-button button primary" @click="sendOnWA">
            Share via WhatsApp
          </button>
        </div>
        ...
        <div class="card-controls">
          ...
          <div class="quotation-picker">
            ...
            <div class="eids-buttons">
              <button
                @click="currentQuotation = eidUlFitarQuotes"
                :class="{ currentEid: currentQuotation.length == 11 }"
              >
                Eid Ul Fitar
              </button>
              <button
                :class="{ currentEid: currentQuotation.length == 10 }"
                @click="currentQuotation = eidUlAdhaQuotes"
              >
                Eid Ul Adha
              </button>
            </div>
            ...
            <div class="quotation-items">
              <ul>
                <li
                  v-for="quotation in currentQuotation"
                  :key="quotation"
